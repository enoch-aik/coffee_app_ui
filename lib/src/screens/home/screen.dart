        ...
        builder: (context, boxState, _) {
          return DefaultTabController(
            ...
            child: KScaffold(
              ...
              body: selectedNavigation.value != 0
                  ? hostBottomNavBody[selectedNavigation.value]
              ...
              bottomNavigationBar: BottomNavigationBar(
                ...
                unselectedIconTheme: IconThemeData(
                    color: CustomColors.defaultTextColor.withOpacity(0.4)),
                onTap: (int value) {
                  selectedNavigation.value = value;
                  print(selectedNavigation.value);
                },
              ),
            ),
          );
