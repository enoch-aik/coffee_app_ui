...
import 'package:coffee_app_ui/src/constant/nav_bar.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ValueNotifier<int> selectedNavigation = ValueNotifier(0);
          ...
          return DefaultTabController(
            ...
            child: KScaffold(
              ...
              body: SingleChildScrollView(
                child: Padding(
                  padding:
                      EdgeInsets.symmetric(horizontal: 23.w, vertical: 30.h),
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TabBar(
                            ...
                            indicator:
                                RoundedTabIndicator(color: CustomColors.brown),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                            children: List.generate(
                                allCoffee.length,
                                (index) =>
                                    coffeeCard(coffee: allCoffee[index]))),
                      ),
              ...
              bottomNavigationBar: BottomNavigationBar(elevation: 0,
                type: BottomNavigationBarType.fixed,backgroundColor: CustomColors.white,
                items: bottomNavItems,
                //iconSize: 29.h,
                showSelectedLabels: false,
                showUnselectedLabels: false,
                selectedIconTheme: IconThemeData(color: CustomColors.brown),
                currentIndex: selectedNavigation.value,
                unselectedIconTheme:
                    IconThemeData(color: CustomColors.defaultTextColor.withOpacity(0.4)),
                onTap: (int value) {
                  selectedNavigation.value = value;
                },
              ),
            ),
          );
